...
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d ""
echo .
curl -i -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d ""
echo .
...
curl -i -X GET http://localhost:10001/cards --header "Authorization: Bearer $token1"
...
curl -i -X GET http://localhost:10001/cards --header "Authorization: Bearer $token2"
echo .
echo .
...
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token2"
echo .
echo .
...
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer $token1" -d "[\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"171f6076-4eb5-4a7d-b3f2-2d650cc3d237\"]"
echo .
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token1"
echo .
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "[\"aa9999a0-734c-49c6-8f4a-651864b14e62\", \"d6e9c720-9b5a-40c7-a6b2-bc34752e3463\", \"d60e23cf-2238-4d49-844f-c7589ee5342e\", \"02a9c76e-b17d-427f-9240-2dd49b0d3bfd\"]"
echo .
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token2"
echo .
echo .
...
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "[\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"171f6076-4eb5-4a7d-b3f2-2d650cc3d237\"]"
echo .
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token2"
echo .
echo .
echo "should fail ... only 3 cards set"
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "[\"aa9999a0-734c-49c6-8f4a-651864b14e62\", \"d6e9c720-9b5a-40c7-a6b2-bc34752e3463\", \"d60e23cf-2238-4d49-844f-c7589ee5342e\"]"
echo .
...
echo "kienboec"
curl -i -X GET http://localhost:10001/deck?format=plain --header "Authorization: Bearer $token1"
echo .
echo .
echo "altenhof"
curl -i -X GET http://localhost:10001/deck?format=plain --header "Authorization: Bearer $token2"
echo .
echo .
...
echo .
curl -i -X GET http://localhost:10001/users/kienboec --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/users/altenhof --header "Authorization: Bearer $token2"
echo .
curl -i -X PUT http://localhost:10001/users/kienboec --header "Content-Type: application/json" --header "Authorization: Bearer $token1" -d "{\"Name\": \"Kienboeck\",  \"Bio\": \"me playin...\", \"Image\": \":-)\"}"
echo .
curl -i -X PUT http://localhost:10001/users/altenhof --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "{\"Name\": \"Altenhofer\", \"Bio\": \"me codin...\",  \"Image\": \":-D\"}"
echo .
curl -i -X GET http://localhost:10001/users/kienboec --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/users/altenhof --header "Authorization: Bearer $token2"
...
echo "should fail:"
curl -i -X GET http://localhost:10001/users/altenhof --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/users/kienboec --header "Authorization: Bearer $token2"
echo .
curl -i -X PUT http://localhost:10001/users/kienboec --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "{\"Name\": \"Hoax\",  \"Bio\": \"me playin...\", \"Image\": \":-)\"}"
echo .
curl -i -X PUT http://localhost:10001/users/altenhof --header "Content-Type: application/json" --header "Authorization: Bearer $token1" -d "{\"Name\": \"Hoax\", \"Bio\": \"me codin...\",  \"Image\": \":-D\"}"
echo .
curl -i -X GET http://localhost:10001/users/someGuy  --header "Authorization: Bearer $token1"
echo .
echo .
...
# --------------------------------------------------
echo "15) stats"
curl -i -X GET http://localhost:10001/stats --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/stats --header "Authorization: Bearer $token2"
echo .
echo .
...
# --------------------------------------------------
echo "16) scoreboard"
curl -i -X GET http://localhost:10001/scoreboard --header "Authorization: Bearer $token1"
echo .
echo .
...
# --------------------------------------------------
echo "17) battle"
curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer $token1" &
curl -i -X POST http://localhost:10001/battles --header "Authorization: Bearer $token2" &
wait
...
curl -i -X GET http://localhost:10001/tradings --header "Authorization: Bearer $token1"
echo .
...
curl -i -X GET http://localhost:10001/tradings --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/tradings --header "Authorization: Bearer $token2"
echo .

read -p "Press any key to resume ..." null

echo "delete trading deals"
curl -i -X DELETE http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Authorization: Bearer $token1"
echo .
echo .
...
curl -i -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer $token1" -d "\"4ec8b269-0dfa-4f97-809a-2c63fe2a0025\""
echo .
...
echo "try to trade"
echo .
curl -i -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer $token2" -d "\"951e886a-0fbf-425d-8df5-af2ee4830d85\""
echo .
curl -i -X GET http://localhost:10001/tradings --header "Authorization: Bearer $token1"
echo .
curl -i -X GET http://localhost:10001/tradings --header "Authorization: Bearer $token2"
